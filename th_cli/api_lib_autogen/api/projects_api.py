...
class _ProjectsApi:
    ...
    def _build_for_applicable_test_cases_api_v1_projects_id_applicable_test_cases_get(self, id: int) -> Awaitable[m.PICSApplicableTestCases]:
        """
    ...
    def _build_for_default_config_api_v1_projects_default_config_get(self) -> Awaitable[m.ResponseDefaultConfigApiV1ProjectsDefaultConfigGet]:
        """
    ...
    def _build_for_read_projects_api_v1_projects_get(self, archived: Optional[bool] = None, skip: Optional[int] = None, limit: Optional[int] = None) -> Awaitable[List[m.Project]]:
        """
    ...
    def _build_for_remove_pics_cluster_type_api_v1_projects_id_pics_cluster_type_delete(self, id: int, cluster_name: str) -> Awaitable[m.Project]:
        """
    ...
    def _build_for_update_project_api_v1_projects_id_put(self, id: int, project_update: m.ProjectUpdate) -> Awaitable[m.Project]:
        """
...
class AsyncProjectsApi(_ProjectsApi):
    async def applicable_test_cases_api_v1_projects_id_applicable_test_cases_get(self, id: int) -> m.PICSApplicableTestCases:
        """
        Retrieve list of applicable test cases based on project identifier.  Args:     id (int): project id  Raises:     HTTPException: if no project exists for provided project id  Returns:     PICSApplicableTestCases: List of applicable test cases
        """
    ...
    async def default_config_api_v1_projects_default_config_get(self) -> m.ResponseDefaultConfigApiV1ProjectsDefaultConfigGet:
        """
        Return default configuration for projects.  Returns:     List[Project]: List of projects
        """
    ...
    async def read_projects_api_v1_projects_get(self, archived: Optional[bool] = None, skip: Optional[int] = None, limit: Optional[int] = None) -> List[m.Project]:
        """
        Retrieve list of projects  Args:     archived (bool, optional): Get archived projects, when true will; get archived         projects only, when false only non-archived projects are returned.         Defaults to false.     skip (int, optional): Pagination offset. Defaults to 0.     limit (int, optional): max number of records to return. Defaults to 100.  Returns:     List[Project]: List of projects
        """
        return await self._build_for_read_projects_api_v1_projects_get(archived=archived, skip=skip, limit=limit)

    async def remove_pics_cluster_type_api_v1_projects_id_pics_cluster_type_delete(self, id: int, cluster_name: str) -> m.Project:
        """
        Removes cluster based on given cluster name  Args:     id (int): ID of Project     cluster_name (str): Name of the cluster to delete  Raises:     HTTPException: if no project exists for provided project id  Returns:     models.Project: Project with updated PICS entry
        """
        return await self._build_for_remove_pics_cluster_type_api_v1_projects_id_pics_cluster_type_delete(id=id, cluster_name=cluster_name)
...
class SyncProjectsApi(_ProjectsApi):
    ...
    def read_project_api_v1_projects_id_get(self, id: int) -> m.Project:
        ...
        return get_event_loop().run_until_complete(coroutine)
    def read_projects_api_v1_projects_get(self, archived: Optional[bool] = None, skip: Optional[int] = None, limit: Optional[int] = None) -> List[m.Project]:
        """
        Retrieve list of projects  Args:     archived (bool, optional): Get archived projects, when true will; get archived         projects only, when false only non-archived projects are returned.         Defaults to false.     skip (int, optional): Pagination offset. Defaults to 0.     limit (int, optional): max number of records to return. Defaults to 100.  Returns:     List[Project]: List of projects
        """
        coroutine = self._build_for_read_projects_api_v1_projects_get(archived=archived, skip=skip, limit=limit)
        return get_event_loop().run_until_complete(coroutine)
    def remove_pics_cluster_type_api_v1_projects_id_pics_cluster_type_delete(self, id: int, cluster_name: str) -> m.Project:
        """
        Removes cluster based on given cluster name  Args:     id (int): ID of Project     cluster_name (str): Name of the cluster to delete  Raises:     HTTPException: if no project exists for provided project id  Returns:     models.Project: Project with updated PICS entry
        """
        coroutine = self._build_for_remove_pics_cluster_type_api_v1_projects_id_pics_cluster_type_delete(id=id, cluster_name=cluster_name)
        return get_event_loop().run_until_complete(coroutine)
