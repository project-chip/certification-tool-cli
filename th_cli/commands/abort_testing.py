...
from th_cli.colorize import colorize_log_header, colorize_log_success
from th_cli.exceptions import CLIError, handle_api_error


@click.command(help=colorize_log_header("Abort the current test execution"))
def abort_testing() -> None:
    ...
    try:
        ...
        click.echo(colorize_log_success(response.get("detail", "Testing aborted")))
    except CLIError:
